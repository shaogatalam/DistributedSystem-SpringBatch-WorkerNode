...
public class BatchWorkerApplication {
	...
	//
	//		return IntegrationFlow
	//				.from(Amqp.inboundAdapter(connectionFactory,"requests").messageConverter(smc))
	...
	//			// Create EmailData object with personalized email content
	...
	//			System.out.println("emailWriter :: ");
